            ...
            <div className="py-12 mt-16 px-6">
                ...
                <aside className="container mx-auto">
                    <div className="flex flex-wrap -mx-5 justify-center">
                        ...
                        >
                            <li>
                                <p className="py-1 block text-white">123456789</p>
                            </li>
                            <li>
                                <p className="py-1 block text-white">himti.univparamdina@gmail.com</p>
                            </li>
                        </FooterLinks>
                        ...
                        >
                            <li>
                                <p className="py-1 block text-white">Jl. Gatot Subroto No.Kav. 97, RT.4/RW.4, Mampang Prpt., Kec. Mampang Prpt., Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12790</p>
                            </li>
                        </FooterLinks>
                        ...
                        >
                            <li>
                                <p className="py-1 block text-white"></p>
                            </li>
                        </FooterLinks>
                    </div>
                </aside>
